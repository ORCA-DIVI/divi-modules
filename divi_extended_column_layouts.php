...
{
    wp_enqueue_style('sb_dcl_admin_css', GET_URI . '/admin/divi/divi_column_layouts/admin.css');
}

function sb_dcl_enqueue()
{
    wp_enqueue_style('sb_dcl_custom_css', GET_URI . '/admin/divi/divi_column_layouts/style.css');
}
...
add_action('et_builder_ready', 'sb_dcl_init');
